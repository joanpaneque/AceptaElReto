...
void displayVectorIntArray(vector<int> arr, int len) {
    cout << arr[0];
    for (int i = 1; i < len; i++)
    {
        cout << " " << arr[i];
...
//     dp[0] = a;
//     dp[1] = b;
//     if (dp[n] != 422) return dp[n];
//     dp[n] = fib(a, b, n - 1) + fib(a, b, n - 2);
//     return dp[n];
// }
...
bool stringContainsAnyChar(string a, string chars) {
...
main() {
    ...
    while(n--) {
        ...
        // cout << (a1[0]) + "." + (stoi(a1[1])+1) + ".0";
        string possibles[3] = {
            to_string(a1[0]+1) + ".0.0",
            to_string(a1[0]) + "." + to_string(a1[1]+1) + ".0",
            to_string(a1[0]) + "." + to_string(a1[1]) + "." + to_string(a1[2]+1)
        };

        if (b == possibles[0] || b == possibles[1] || b == possibles[2]) {
            cout << "SI\n";
        } else {
            cout << "NO\n";
        }
